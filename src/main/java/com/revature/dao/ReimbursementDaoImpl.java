...
public class ReimbursementDaoImpl implements ReimbursementDao{
	...
	public List<Reimbursement> getAllReimbursements() {
		...
		try(Session session = HibernateUtil.getSessionFactory().openSession()) {
			...
			TypedQuery<Reimbursement> query = session.createQuery("from Reimbursement ORDER BY reimbId", Reimbursement.class);
	...
	public List<Reimbursement> getResolvedReimbs(int statusOneId, int statusTwoId) {
		try(Session session = HibernateUtil.getSessionFactory().openSession()) {
			...
			List<Reimbursement> reimbs = session.createNativeQuery(sql, Reimbursement.class)
					.setParameter("statusOneId", statusOneId)
					.setParameter("statusTwoId", statusTwoId)
					.list();
	...
	public Reimbursement getReceipt(int reimbId) {
		...
		try(Session session = HibernateUtil.getSessionFactory().openSession()) {
			...
			TypedQuery<Reimbursement> query = session.createQuery("from Reimbursement WHERE reimbId= :reimbId", Reimbursement.class);
			query.setParameter("reimbId", reimbId);
