...
if (sessionStorage.getItem('userRole') == 'Employee') {
    ...
    function fetchData() {
        ...
        fetch('http://ec2-18-191-62-185.us-east-2.compute.amazonaws.com:8080/project-1/getUser')
            .then(response => {
    ...
    function fetchData() {
        ...
        fetch('http://ec2-18-191-62-185.us-east-2.compute.amazonaws.com:8080/project-1/getAllUsers')
            .then(response => {
