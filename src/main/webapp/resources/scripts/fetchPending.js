...
if (sessionStorage.getItem('userRole') == 'Manager') {
    ...
    function fetchData() {
        ...
        fetch('http://ec2-18-191-62-185.us-east-2.compute.amazonaws.com:8080/project-1/getReimbsByStatus', {
            method: 'POST',
            redirect: 'follow',
            credentials: 'include',
            headers: {
...
function redirectShowReceipt(val){
    ...
    window.location.href = 'http://ec2-18-191-62-185.us-east-2.compute.amazonaws.com:8080/project-1/resources/html/showReceipt.html';
