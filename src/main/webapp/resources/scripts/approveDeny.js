...
if (sessionStorage.getItem('userRole') == 'Manager') {
    ...
    function approve(val) {
        ...
        function approveUpdate(val) {
            ...
            fetch('http://ec2-18-191-62-185.us-east-2.compute.amazonaws.com:8080/project-1/approveReimb', {
                method: 'POST',
                redirect: 'follow',
                credentials: 'include',
                headers: {
                ...
                if (data.status == 'process failed') {
                    ...
                    window.location.href = 'http://ec2-18-191-62-185.us-east-2.compute.amazonaws.com:8080/project-1/resources/html/error.html'
                } else if (data.status == 'Approved Success') {
                    if (data.email == 'Email Success') {
                        alert("Approved success and email sent successfully");
                        window.location.href = 'http://ec2-18-191-62-185.us-east-2.compute.amazonaws.com:8080/project-1/resources/html/MngApproveDeny.html'
                    }
                }
    ...
    function deny(val) {
        ...
        function denyUpdate(val) {
            ...
            fetch('http://ec2-18-191-62-185.us-east-2.compute.amazonaws.com:8080/project-1/denyReimb', {
                method: 'POST',
                redirect: 'follow',
                credentials: 'include',
                headers: {
                ...
                if (data.status == 'process failed') {
                    ...
                    console.log('unauthorized access')
                    window.location.href = 'http://ec2-18-191-62-185.us-east-2.compute.amazonaws.com:8080/project-1/resources/html/error.html'
                } else if (data.status == 'Denied Success') {
                    if (data.email == 'Email Success') {
    ...
    function redirectShowReceipt(val){
        ...
        window.location.href = 'http://ec2-18-191-62-185.us-east-2.compute.amazonaws.com:8080/project-1/resources/html/MngReceipt.html';
