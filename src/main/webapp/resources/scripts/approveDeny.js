...
if (sessionStorage.getItem('userRole') == 'Manager') {
    ...
    function approve(val) {
        ...
        function approveUpdate(val) {
            ...
            fetch('http://ec2-3-129-208-148.us-east-2.compute.amazonaws.com:8080/project-1/approveReimb', {
                method: 'POST',
                redirect: 'follow',
                credentials: 'include',
                headers: {
                ...
                if (data.status == 'process failed') {
                    ...
                    if (data.email == 'Email Success') {
                        ...
                        window.location.href = 'http://ec2-3-129-208-148.us-east-2.compute.amazonaws.com:8080/project-1/resources/html/MngApproveDeny.html'
                    }
                }
    ...
    function deny(val) {
        ...
        function denyUpdate(val) {
            ...
            fetch('http://ec2-3-129-208-148.us-east-2.compute.amazonaws.com:8080/project-1/denyReimb', {
                method: 'POST',
                redirect: 'follow',
                credentials: 'include',
                headers: {
