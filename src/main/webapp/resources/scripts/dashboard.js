...
if (sessionStorage.getItem('userRole') == 'Employee') {
    ...
    function fetchData() {
        ...
        fetch('http://ec2-18-191-62-185.us-east-2.compute.amazonaws.com:8080/project-1/getAllReimbs', {
            method: 'POST',
            redirect: 'follow',
            credentials: 'include',
            headers: {
    ...
    function redirectShowReceipt(val){
        ...
        window.location.href = 'http://ec2-18-191-62-185.us-east-2.compute.amazonaws.com:8080/project-1/resources/html/EmpReceipt.html';
